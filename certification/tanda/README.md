...
These scripts certify the frozen SDK candidate `rc/v0.1.0-rc1` against a real RouterOS HotSpot without installing the SDK into BOZZ-CENTER Gateway.

Frozen candidate:

- SDK SHA: `2f67c90762718b3678cff9b553a95adbf95ce457`
...
```bash
export ROUTEROS_TEST_USER='BOZZ-RC1-LAB'
...
secret-command | sh certification/tanda/run.sh soak > rc1-soak-2h.jsonl
```
...
export ROUTEROS_SOAK_SAMPLE_SECONDS=60
secret-command | sh certification/tanda/run.sh soak > rc1-soak-24h.jsonl
```
